  ...
  return (
    <Dialog.Root open={opened} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed flex flex-col items-center justify-center w-full h-full p-6">
          <div className="flex flex-col w-full max-w-[512px] min-h-300px bg-zinc-50 rounded-xl p-6">
            {isGetting ? (
              <Spinner />
            ) : (
              <>
